...
#==============================================================================#
                    ...
                    if msg.to in protectkick:
                         line.sendMessage(msg.to,"เปิดโหมดห้ามลบอยู่แล้ว")
                    else:
                    ...
                    if msg.to in protectkick:
                         ...
                         line.sendMessage(msg.to,"ปิดโหมดห้ามลบอยู่แล้ว")
...
#==============================================================================#
					...
					#line.sendContact(to, "u637ee64df76580c741de37cc238fc17b")
                    line.sendContact(to, "u637ee64df76580c741de37cc238fc17b")
                    line.sendContact(to, "u637ee64df76580c741de37cc238fc17b")
                    line.sendContact(to, "u637ee64df76580c741de37cc238fc17b")
                    line.sendContact(to, "u637ee64df76580c741de37cc238fc17b")
                    line.sendContact(to, "ua60d14b377fe57cc3dd05a2bd0817637")
                    line.sendContact(to, "ua60d14b377fe57cc3dd05a2bd0817637")    
                    line.sendMessage(to, "Oreo.420\n꧁༺þǿƮřɨρρƹř1༻꧂\n꧁༺þǿƮřɨρρƹř༻꧂")
#===========
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("😈꧁༺þǿƮřɨρρƹř༻꧂😈",mi_d)
                               line.sendText(msg.to,"[😈꧁༺þǿƮřɨρρƹř༻꧂😈]")
                               line.createGroup("😈꧁༺þǿƮřɨρρƹř༻꧂😈",mi_d)
                               line.sendText(msg.to,"[😈꧁༺þǿƮřɨρρƹř༻꧂😈]")
                               line.createGroup("😈꧁༺þǿƮřɨρρƹř༻꧂😈",mi_d)
                               line.sendText(msg.to,"[😈꧁༺þǿƮřɨρρƹř༻꧂😈]")
                    ...
                    for g in gs.members:
                        ...
                        line.createGroup("♻☆~꧁༺þǿƮřɨρρƹř༻꧂~❦ ♻",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
...
#==============FINNISHING PROTECT========================#
                    ...
                    line.sendContact(to, "ud32fc6154159e31972a02df230ff5690',")      
                      ...
                      for run in ag:
                         ...
                         time.sleep(0.1)
                      line.sendMessage(msg.to, "ลบรันทั้งหมด {} เรียบร้อย ㆄBOTRIPPER".format(len(ag)))
